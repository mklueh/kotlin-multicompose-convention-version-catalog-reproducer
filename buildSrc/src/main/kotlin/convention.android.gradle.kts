plugins {
     ...
     * TODO Causes
     *
     * An exception occurred applying plugin request [id: 'com.android.application', version: '8.9.2']
     ...
     *
     * * Exception is:
     * org.gradle.api.plugins.InvalidPluginException: An exception occurred applying plugin request [id: 'com.android.application', version: '8.9.2']
     ...
     * 	... 206 more
     * Caused by: org.gradle.api.reflect.ObjectInstantiationException: Could not create an instance of type org.jetbrains.kotlin.gradle.plugin.mpp.KotlinAndroidTarget.
     ...
     * 	at org.gradle.api.internal.model.DefaultObjectFactory.newInstance(DefaultObjectFactory.java:99)
     * 	at org.jetbrains.kotlin.gradle.plugin.mpp.KotlinAndroidTargetKt.KotlinAndroidTarget(KotlinAndroidTarget.kt:350)
     * 	at org.jetbrains.kotlin.gradle.plugin.mpp.KotlinAndroidTargetKt.KotlinAndroidTarget$default(KotlinAndroidTarget.kt:30)
     * 	at org.jetbrains.kotlin.gradle.plugin.KotlinAndroidPlugin$apply$1.invoke(KotlinAndroidPlugin.kt:28)
     * 	at org.jetbrains.kotlin.gradle.plugin.KotlinAndroidPlugin$apply$1.invoke(KotlinAndroidPlugin.kt:26)
     * 	at org.jetbrains.kotlin.gradle.plugin.KotlinAndroidPlugin$Companion$dynamicallyApplyWhenAndroidPluginIsApplied$2$1.execute(KotlinAndroidPlugin.kt:63)
     * 	at org.jetbrains.kotlin.gradle.plugin.KotlinAndroidPlugin$Companion$dynamicallyApplyWhenAndroidPluginIsApplied$2$1.execute(KotlinAndroidPlugin.kt:61)
     ...
     * 	at org.gradle.api.internal.plugins.DefaultPluginManager$1.run(DefaultPluginManager.java:116)
     * 	at org.gradle.api.internal.plugins.DefaultPluginManager.addPlugin(DefaultPluginManager.java:201)
     ...
     * 	at org.gradle.internal.instantiation.generator.AbstractClassGenerator.generateUnderLock(AbstractClassGenerator.java:261)
     * 	at org.gradle.cache.internal.DefaultCrossBuildInMemoryCacheFactory$AbstractCrossBuildInMemoryCache.produce(DefaultCrossBuildInMemoryCacheFactory.java:182)
     * 	at org.gradle.cache.internal.DefaultCrossBuildInMemoryCacheFactory$AbstractCrossBuildInMemoryCache.produceAndRetain(DefaultCrossBuildInMemoryCacheFactory.java:174)
     * 	at org.gradle.cache.internal.DefaultCrossBuildInMemoryCacheFactory$AbstractCrossBuildInMemoryCache.lambda$get$1(DefaultCrossBuildInMemoryCacheFactory.java:162)
     * 	at org.gradle.internal.lazy.LockingLazy.get(LockingLazy.java:61)
     * 	at org.gradle.cache.internal.DefaultCrossBuildInMemoryCacheFactory$AbstractCrossBuildInMemoryCache.get(DefaultCrossBuildInMemoryCacheFactory.java:163)
     * 	at org.gradle.internal.instantiation.generator.AbstractClassGenerator.generate(AbstractClassGenerator.java:190)
     * 	at org.gradle.internal.instantiation.generator.AsmBackedClassGenerator.generate(AsmBackedClassGenerator.java:124)
     ...
     * 	at org.gradle.internal.instantiation.generator.AbstractClassGenerator.inspectType(AbstractClassGenerator.java:290)
     * 	at org.gradle.internal.instantiation.generator.AbstractClassGenerator.generateUnderLock(AbstractClassGenerator.java:230)
     * 	... 276 more
